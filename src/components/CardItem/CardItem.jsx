...
const CardItem = () => (<article className={s.card}>
    ...
    <button className={s.button} type="button">В корзину</button>
    <svg className={s.heart} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
